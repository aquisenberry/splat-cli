function percentLoaded(game) {
  ...
  return (
    (game.images.bytesLoaded() + game.sounds.assets.bytesLoaded()) /
    (game.images.totalBytes() + game.sounds.assets.totalBytes())
  );
}
...
export default function (ecs, game) {
  ...
  ecs.add(function renderLoadingBar(entity, elapsed) {
